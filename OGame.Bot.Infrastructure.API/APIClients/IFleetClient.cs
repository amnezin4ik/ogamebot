...
namespace OGame.Bot.Infrastructure.API.APIClients
{
    ...
    {
        Task<Fleet> GetActivePlanetFleetAsync(SessionData sessionData);
        ...
        Task SendFleetPhase3(SessionData sessionData, SendFleetPhase3Info sendFleetPhase3Info, Resources resources);
    }
}